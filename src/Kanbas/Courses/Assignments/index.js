				...
				<div className='row p-0'>
					<div className='col-12 p-0 d-flex mt-2 mb-2'>
						...
						<div className='float-end full-width'>
							...
							<button
								type='button'
								className='btn btn-danger float-end wd-cab wd-inline'>
								<i className='fa-solid fa-plus white'></i> Assignment
							</button>
							<button
								type='button'
								className='btn btn-light float-end wd-cab wd-inline'>
								<i className='fa-solid fa-plus wd-black'></i> Group
							</button>
						</div>
					</div>
				</div>
			...
			<div className='row'>
				<ul className='list-group module-group'>
					<li className='list-group-item list-group-item-secondary'>
						...
						<i className='fa-solid fa-ellipsis-vertical wd-black float-end ma-050'></i>
								...
								<li className='list-group-item done container-fluid p-0 m-0'>
									<div className='row p-0 m-0 align-items-center'>
										<div className='col-1 p-0 m-0 text-center'>
											<i className='fa-solid fa-book wd-green ps-2'></i>
										</div>
										...
										<div className='col-1 p-0 m-0 text-center'>
											<i className='fa-solid fa-check-circle wd-green'></i>
											<i className='fa-solid fa-ellipsis-vertical wd-black ma-050'></i>
										</div>
									</div>
								</li>
							</Link>
